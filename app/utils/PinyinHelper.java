...
public class PinyinHelper {
	...
	public static void main(String[] args) {
		...
		PinyinHelper finder = PinyinHelper.getInstance();
		finder.setResource("南京 蓝天");
		// 获取全拼字母
		System.out.println(finder.getSpelling());
		// 获取首字母
		System.out.println(finder.getFirstSelling("G英文字符"));
	...
	private static PinyinHelper chineseSpelling = null;
	...
	public static PinyinHelper getInstance() {
		if (chineseSpelling == null) {
			chineseSpelling = new PinyinHelper();
		}
